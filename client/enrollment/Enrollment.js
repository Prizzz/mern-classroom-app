      ...
      >
        ...
        <List>
          <ListItem
            ...
            className={values.drawer == -1 ? classes.selectedDrawer : classes.unselected}
          >
            <ListItemIcon>
              <Info />
            </ListItemIcon>
            ...
            <ListItemText
              primary={
                <div className={classes.progress}>
                  <span>{totalComplete}</span> out of <span>{enrollment.lessonStatus.length}</span>{' '}
                  completed
                </div>
              }
            />
      ...
      {values.drawer == -1 && (
        <Card className={classes.card}>
          <CardHeader
            ...
            subheader={
              <div>
                <Link to={'/user/' + enrollment.course.instructor._id} className={classes.sub}>
          ...
          <div>
            <CardHeader
              ...
              action={
                ...
                auth.isAuthenticated().user._id == enrollment.course.instructor._id && (
      ...
      {values.drawer != -1 && (
        <>
          ...
          <Card className={classes.card}>
            <CardHeader
              ...
              action={
                <Button
                  ...
                  variant={
                    enrollment.lessonStatus[values.drawer].complete ? 'contained' : 'outlined'
                  }
                  color="secondary"
                >
            ...
            <CardActions>
              <a href={enrollment.course.lessons[values.drawer].resource_url} target="_blank">
